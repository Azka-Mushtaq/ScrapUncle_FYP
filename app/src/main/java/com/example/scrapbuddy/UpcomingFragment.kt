...
class UpcomingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        containerName = if (userRole == "user") R.id.frame_container
        else R.id.rider_frame_container
        ...
        val pickups = if (userRole == "user") {
            db.getPickupsForCustomer(userId, false)
        } else {
            db.getPickupsForRider(userId, "confirmed")
        }
        ...
        if (pickups != null) {
            ...
            val list = view.findViewById<ListView>(R.id.upcoming_pickup_list_view)
